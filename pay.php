...
<section class="">
		...
		?>
			...
			<section class="caption">
				<h2 class="caption" style="text-align: center">PAY</h2>
			</section>
	...
	<section class="search">
		<div class="wrapper">
			<form action="#" method="post">
				<input type="text" id="search" name="search" placeholder=" Payment via cash also acceptable. Visit our office"  autocomplete="off"/>
	...
	<section class="listings">
		<div class="wrapper">
			<ul class="properties_list">
				...
				<form method="post">
				<h3>Payment via Credit or debit Card</h3>
					<table>
						<tr>
							<td>Card Number:</td>
